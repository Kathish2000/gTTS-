...
def respond(voice_data):
    ...
    if there_exists(["what is your name", "what's your name", "tell me your name"]):
        if person_obj.name:
            ...
            engine_speak("my name is  . what's your name?")
    ...
    if there_exists(["show my time table"]):
        im = Image.open(r"/storage/emulator/0/Download/icon.jpeg/")
        im.show()
    ...
    if there_exists(["capture", "my screen", "screenshot"]):
        ...
        myScreenshot.save('/storage/emulator/0/Download/Screenshot/screen.png')
...
while (1):
    ...
    print("Done")
    print("/storage/emulator/0/Download/Screenshot/", voice_data)
